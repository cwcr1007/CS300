...
/**
 * Carrot Patch Tester class implement the method to check the correctness of the Animal.isClose() 
 * methods. This class extends the CarrotPatch class and override its setup() method.
 */
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    try {
      ...
      w1.setX(400); 
      w1.setY(200);
      // Set second Wolf at position(250,200)
      w2.setX(250); // First Wolf is 150px away from second Wolf
      w2.setY(200);
      if (w1.isClose(w2, Wolf.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Wolf.isClose() returned true when it should return false.");
        return false;
      }
