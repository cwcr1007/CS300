...
/**
 * This class models a list of Animals. It plays the role of a base class of any specific animal
 * type such as Rabbit and Wolf
 *
 */
public class Animal implements GUIListener {
   ...
   * 
   * @return whether the mouse is over the animal
   */
  @Override
  ...
  public boolean isClose(int x, int y, int range) {
    ...
    return this.distance(x, y) <= range;
  }
  ...
  public boolean isClose(Animal otherAnimal, int range) {
    // TODO implement this method
    return this.distance(otherAnimal.x, otherAnimal.y) <= range;
  }
